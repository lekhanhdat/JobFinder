import { SafeAreaView, ScrollView, StyleSheet, View, Image, Text, TextInput, TouchableOpacity} from "react-native";
        ...
        <SafeAreaView>
            <ScrollView>
                ...
                <View style={{marginLeft:30, marginTop:40}}>
                    <Text style={{fontWeight:500, marginBottom:5, fontSize:16}}>Upload CV</Text>
                    <Text>Add your CV/resume to apply for a job</Text>
                </View>
                <View style={styles.upload_container}>
                    <Text style={{color:COLORS.maugach}}>Upload your file here</Text>
                    <Feather name="upload" size={24} color={COLORS.maugach} />
                </View>
                <View style={{flexDirection:'row', marginLeft: 30}}>
                    <AntDesign name="delete" size={24} color="black" />
                    <View style={{marginLeft:5, justifyContent: 'center', alignItems: 'center'}}><Text>Remove CV</Text></View>
                </View>
                <View style={{margin:30, marginBottom:10}}>
                    <Text style={{fontWeight:500, fontSize:16, marginBottom:10}}>Information</Text>
                    <View style={{borderWidth:1, borderColor:'#d9d9d9', height:120}}>
                        <TextInput multiline={true} placeholder="Explain why you are the right person for this job"></TextInput>
                    </View>
                </View>
                <TouchableOpacity 
