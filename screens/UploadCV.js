...
import { SafeAreaView, ScrollView, StyleSheet, View, Image, Text, TextInput, TouchableOpacity, Alert } from "react-native";
    ...
    return (
        <SafeAreaView>
            <ScrollView>
                ...
                <TouchableOpacity style={styles.upload_container} onPress={handleDocumentSelection}>
                    {cvFile ? (
                        <>
                ...
                {isAvailable ?
                    <TouchableOpacity
                        style={{
                            backgroundColor: description ? COLORS.maugach : '#d3d3d3',
                            marginLeft: 30,
                            marginRight: 30,
                            height: 50,
                            borderRadius: 20,
                    ...
                    </TouchableOpacity> : <Text>Email not available</Text>
                }
